...
const Wrapper = styled.div<{ cssVarPrefix: string }>`
  ...
  .c-1 {
    rotate: 0deg;
    animation: ${(p) =>
      `var(--${p.cssVarPrefix}spinner-animation-speed, 0.8s) linear infinite moon_2-anim-1`};
  }

  @keyframes moon_2-anim-1 {
    10% {
      rotate: 0deg;
    }
    40% {
...
const SpinnerMoon2 = memo((props: any) => {
  const {
    theme: { cssVarPrefix },
